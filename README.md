...
- **Više administratora** – u *Podešavanja → Korisnici sistema* admin može bilo kom korisniku da klikne **👑 Postavi za admina**; ta osoba odmah dobija isti meni, izgled i sva prava kao admin (odobravanje zahteva, radnici, izveštaji, podešavanja), a ako ima svoj profil radnika, zadržava i *Moj kalendar / Podnesi zahtev / Moj profil*. Prava se uklanjaju dugmetom **Ukloni admina**. Sopstvenu ulogu ne možeš da menjaš, pa aplikacija nikad ne može slučajno ostati bez admina.
...
- **Admin upisuje odsustvo umesto radnika** – ako radnik nije podneo zahtev a bio je odsutan, admin klikne **➕ Unesi odsustvo za radnika** (na stranici *Zahtevi*) ili **➕ Unesi odsustvo** (na *Detalji radnika*), izabere radnika, tip, datume i napomenu. Odsustvo se odmah upisuje kao odobreno, dani se obračunavaju isto kao kod odobrenog zahteva (prošli datumi se odmah oduzimaju), radnik dobija obaveštenje, a u istoriji piše „upisao admin”. Bolovanje može da se upiše i bez datuma završetka (u toku).
